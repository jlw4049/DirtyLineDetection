...
# image.save(r"C:\Users\jlw_4\Desktop\test image1212121212.png")
...
# vidObj = cv2.VideoCapture(r"C:\Users\jlw_4\Desktop\Anything Goes (1956).mp4")
#
...
#     print(total)
#     frame1 = int(total * 0.20)
#     frame2 = int(total * 0.30)
#     frame3 = int(total * 0.40)
#     frame4 = int(total * 0.50)
#     frame5 = int(total * 0.60)
#     frame6 = int(total * 0.70)
#     frame7 = int(total * 0.80)
#     # print(total, frame4)
#
#     vidObj.set(1, 148000)
#     ret, frame = vidObj.read()
#     print(ret, frame)
#     cv2.imwrite(r"C:\Users\jlw_4\Desktop\data\hello.jpg", frame)

    # vidObj.set(cv2.CAP_PROP_POS_MSEC, frame1)
    # cv2.imwrite(r"C:\Users\jlw_4\Desktop\data\frame.jpg", frame)
    # vidObj.
    # print(list(vidObj.read())[1])
    # img = cv2.cvtColor(list(vidObj.read())[1], cv2.COLOR_BGR2RGB)
    ...
    #         if index % 29 != 0:
    #             continue
    #         cv2.imwrite(r"C:\Users\jlw_4\Desktop\data" + '/' + str(index) + '.png', Mat)
    #         print('cont')
    #     else:
    #         print('break')
    #         break
...
# frames = FrameCapture(r"C:\Users\jlw_4\Desktop\rugrats test\The.Rugrats.Movie.1998.1080p.BluRay.REMUX.AVC.TrueHD.5.1.mkv")
...
#         self.canvas.pack()
#         frame.pack()
#         self.orig_img = Image.open(r"C:\Users\jlw_4\Desktop\test image.png").convert('L').filter(ImageFilter.FIND_EDGES)
...
filename = r"C:\Users\jlw_4\Desktop\test image.png"  # place path to your image here
